...
class MainWindow(object):
	...
	def showLicenseDialog(self, MainWindow):
		...
		try:
			...
			licenseText.setText("Licensed under the GNU GENERAL PUBLIC LICENSE Version 3 or newer.<br/>See &lt;<a href=\"http://www.gnu.org/licenses/\">http://www.gnu.org/licenses/</a>&gt;")
		okButton = QtGui.QPushButton("Ok")
	...
	def showAboutDialog(self, MainWindow, version):
		...
		aboutText.setText("<div align=\"center\"><h1>BoarG %s</h1><br/>BoarG is a simple GUI for the<br/>version control system boar.<br/><a href=\"http://www.boarvcs.com\">www.boarvcs.com</a><br/><br/><small>Copyright &copy;2014 - Robert Einhaus</small><br/><br/><a href=\"http://boarg.wbbu.de\">boarg.wbbu.de</a><br/><br/><br/>This program comes with ABSOLUTELY NO WARRANTY.<br/>This is free software, and you are welcome to<br/>redistribute it under certain conditions.</div>" % version)
	...
	def showRemoveDirDialog(self, MainWindow):
		...
		removeDirText.setText("Are you sure you want to delete the following entries:\n\n" + dirStr)
	...
	def showSessionDialog(self, MainWindow, dir, session = "", repo = "", ignore = ""):
		...
		return { "code":ret, "dir":dirInput.text(), "session":sessionInput.text(), "repo":repoInput.text(), "ignore":ignoreList.toPlainText() }
		

	def retranslateUi(self, MainWindow):
		MainWindow.setWindowTitle(QtGui.QApplication.translate("MainWindow", "BoarG", None, QtGui.QApplication.UnicodeUTF8))
		self.menuFile.setTitle(QtGui.QApplication.translate("MainWindow", "File", None, QtGui.QApplication.UnicodeUTF8))
		self.menuBoar.setTitle(QtGui.QApplication.translate("MainWindow", "Boar", None, QtGui.QApplication.UnicodeUTF8))
